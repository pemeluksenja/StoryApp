package com.pemeluksenja.storyappdicoding.registerview
...
class NameEditTextCustom : AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable) {
                ...
                when {
                    name.length() < 6 -> {
                        name.error = "Password harus lebih panjang dari 6 karakter"
                    }
                }
            }
        })
